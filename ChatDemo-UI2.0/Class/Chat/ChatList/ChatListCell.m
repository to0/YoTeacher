    ...
    reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        // Initialization code
        _avatarImageView = [[EGOImageView alloc] initWithFrame:CGRectMake(10, 7, 45, 45)];
        _avatarImageView.placeholderImage = [UIImage imageNamed:@"comment_avatar.png"];
...
-(void)setImageURL:(NSURL *)imageURL {
    _imageURL = imageURL;
    _avatarImageView.imageURL = imageURL;
}

-(void)setPlaceholderImage:(UIImage *)placeholderImage {
    _placeholderImage = placeholderImage;
    _avatarImageView.placeholderImage = placeholderImage;
}
