...
+ (void) MR_initializeDefaultContextWithCoordinator:(NSPersistentStoreCoordinator *)coordinator;
{
    if (defaultManagedObjectContext_ == nil)
    {
        ...
        NSManagedObjectContext *defaultObjContext = [self MR_newMainQueueContext];
        [self MR_setDefaultContext:defaultObjContext];
        
        [defaultObjContext setParentContext:rootContext];
    }
}
